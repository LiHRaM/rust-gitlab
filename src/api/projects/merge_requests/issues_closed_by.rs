...
#[cfg(test)]
mod tests {
    use crate::api::projects::merge_requests::{IssuesClosedBy, IssuesClosedByBuilderError};
    ...
    fn project_and_merge_request_are_needed() {
        ...
        crate::test::assert_missing_field!(err, IssuesClosedByBuilderError, "project");
    }
    ...
    fn merge_request_is_needed() {
        ...
        crate::test::assert_missing_field!(err, IssuesClosedByBuilderError, "merge_request");
    }
